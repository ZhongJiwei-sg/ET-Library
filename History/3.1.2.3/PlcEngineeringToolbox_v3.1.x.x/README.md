...
- IO/Analog/FB AnalogIn
	Updated FB AnalogIn to handled scaling for terminals with extend range (107%-EL3x7x) by setting Options.5. Scaling of Min/MaxValue will be based on 30518 instead of full 16bit (32767) which is representing 107% of the user units.
